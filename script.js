const levels = [
  ...
  { title: 'רוח גבית', instruction: 'בנו טור בצד שמאל של הלוח. החללית הראשונה צריכה להיות למטה, ושאר החלליות יעלו מעליה.', tip: 'כדי להפוך את סדר הטור השתמשו ב־flex-direction: column-reverse. ב־justify-content כתבו flex-start כדי להתחיל מלמטה. בגלל שהלוח בעברית (RTL), כתבו flex-end ב־align-items כדי להצמיד את הטור לשמאל.', target: 'טור הפוך · התחלה · צד שמאל', values: { direction: 'column-reverse', justify: 'flex-start', align: 'flex-end', wrap: 'nowrap' } },
